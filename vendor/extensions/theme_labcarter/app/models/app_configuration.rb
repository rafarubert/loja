class AppConfiguration < Configuration
  ...
  # SECURE_CONNECTION_TYPES = ['None']
  SECURE_CONNECTION_TYPES = ['None','SSL','TLS']

  preference :site_name, :string, :default => 'LabCarterShop'
  preference :site_url, :string, :default => 'labcartershop.bondix.com.br'
  ...
  preference :logo, :string, :default => '/images/labcarter-logo.png'
  preference :stylesheets, :string, :default => 'screen,labcarter' # Comma separate multiple stylesheets, e.g. 'screen,mystyle'
  preference :admin_interface_logo, :string, :default => "images/labcarter-logo.png"
